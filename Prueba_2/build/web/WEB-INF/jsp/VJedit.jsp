...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>Editar Videojuego - Prueba_2</title>
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2/css/bootstrap.min.css"/>
    </head>
    <body>
        <h1>Hola desde editar videojuego</h1>
        <a href="<c:url value="/home.htm"/>">Regresar a Home</a>
        <hr/>
        <a href="<c:url value="/videojuegos.htm"/>">Regresar a Lista de videojuegos</a>
        <hr/>
        ...
        <form:form method="post" commandName="videojuego" >
            ...
            <hr/>
            <form:button class="btn btn-primary">Finalizar edición</form:button>
        </form:form>
        </div>
    </body>
</html>
