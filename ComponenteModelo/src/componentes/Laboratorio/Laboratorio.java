package componentes.Laboratorio;
...
public class Laboratorio extends ExistenciaMaterialMedico {
    ...
    public Laboratorio(Integer id, Integer codigo,String nombreMaterial, String fechaConteo, Integer cantidadExistencia, Integer cantidadFaltante, String observacion) {
        super(id, codigo, nombreMaterial, fechaConteo, cantidadExistencia, cantidadFaltante, observacion);
    }

    public Laboratorio(Integer id, String tipoFabricacion, String uso, String formaPresentacion, Integer idExist, Integer codigo, String nombreMaterial, String fechaConteo, Integer cantidadExistencia, Integer cantidadFaltante, String observacion) {
