...
<html>
    <head>
        <meta charset="UTF-8" />
        <title>VIH - Editar Personal</title>
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2/css/bootstrap.min.css"/>
    </head>
    <body>
        <h1>Hola desde Edicion de Personal de area</h1>
        <br>
        ...
        <div style="text-align:center;">
            <form:form method="POST" commandName="personal" >
                ...
                <hr/>
                <form:button class="btn btn-primary">Terminar edicion de Personal de area</form:button>
            </form:form>
