  ...
  <body>
    ...
    <main role="main">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4">
            <h2>Ingresar Material laboratorio</h2>
            <p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
            <p><a class="btn btn-secondary" href="<c:url value="MaterialLaboratorioAdd.htm"/>" role="button">View details &raquo;</a></p>
          </div>
          <div class="col-md-4">
            <h2>Ingresar Material TAR</h2>
            <p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
            <p><a class="btn btn-secondary" href="<c:url value="MaterialTarAdd.htm"/>" role="button">View details &raquo;</a></p>
          </div>
          <div class="col-md-4">
