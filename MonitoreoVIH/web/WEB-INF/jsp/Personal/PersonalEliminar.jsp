...
<html lang="en">
  <head>
    ...
    <title>Monitoreo VIH - Eliminar Personal </title>
  ...
  <body>
    ...
    <main role="main">
      ...
      <div class="jumbotron">
        <div class="container">
          <h1 class="display-3">Petición de Eliminar Personal de area realizada...</h1>
          <br><br><br>
          <div style="text-align: center">
          <h3><c:out value="${respuestaEliminar}"/></h3>
          <h3><c:out value="${respuestaerror}"/></h3>
          <br><br><br>
          <p><a class="btn btn-success btn-lg" href="<c:out value="Personals.htm"/>" role="button">Regresar </a></p>
          </div>
          </div>
      </div>
    </main><!-- Principal -->
