...
<html lang="en">
    <head>
        ...
        <title>Monitoreo VIH - Material</title>
    ...
    <body>
        ...
        <main role="main">
            ...
            <div class="jumbotron">
                ...
                <div class="container">
                    <h1 class="display-4">Añadiendo Material...</h1>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <form:form method="post" commandName="existencia" >
                            ...
                            <p>
                                <form:label path="nombreMaterial">Nombre material:</form:label><br>
                                <form:input path="nombreMaterial" />
                                <form:errors path="nombreMaterial" element="div" cssClass="alert alert-danger"/>

                            </p>
                            <p>
                                <form:label path="fechaConteo">Fecha Conteo</form:label><br>
