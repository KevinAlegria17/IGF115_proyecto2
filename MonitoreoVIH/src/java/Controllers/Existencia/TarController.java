...
package Controllers.Existencia;

import Modelos.Conectar;
import componentes.DefinicionComponenteExistencia;
import componentes.Existencia.ExistenciaMaterialMedico;
import componentes.Existencia.TAR;
...
public class TarController {
    ...
    public ModelAndView form(){
        ...
        mav.setViewName("Existencia/MaterialLaboratorioAdd");
            ...
            )
    {
                ...
                try {
                    ...
                    String response = definicionExistencia.insertartar(
                            existencia.getId(), existencia.getCodigo(), existencia.getNombreMaterial(),existencia.getFechaConteo(), 
    ...
    public ModelAndView Tars() {
        ModelAndView mav = new ModelAndView();
        mav.setViewName("Existencia/Tar/Tars");
    ...
    public ModelAndView laboratorioEditar(HttpServletRequest request) {
        ModelAndView mav = new ModelAndView();
        int id = Integer.parseInt(request.getParameter("id"));
        mav.setViewName("Existencia/Tar/TarEditar");
        String sqllin ="select * from linea_de_nivel;";
        List datoslineas = this.jdbcTemplate.queryForList(sqllin);
        mav.addObject("lineas",datoslineas);
        try {
